...
public class GenerarTicketAdicionalView {
    ...
    private void agregarFilaSesionDinamica(String desc, double costo, String fechaSesion) {
        ...
        // Formateamos la descripción para que incluya la fecha entre paréntesis
